...
///
/// ``VenariAIError`` describes problems which occur through the lifecycle of making a request to the API, from constructing the underlying network request, through making the network request and handling the resulting response.
///
/// Most of the error values have associated failure reasons:
/// - ``VenariAIError/failedToConstructRequestURL(_:)``
/// - ``VenariAIError/failedToSerializeRequestParameters(_:)``
/// - ``VenariAIError/failedToConstructRequest(_:)``
/// - ``VenariAIError/failedToHandleResponse(_:)``
///
/// which provide more information about why the error occurred.
///
/// If a network error occurs when making an API request, ``VenariAIError/failedToMakeNetworkRequest(error:)`` has an associated [`Error`](https://developer.apple.com/documentation/swift/error) value which describes more information about why the network error occurred.
///
/// In exceptional circumstances there may be an internal error which occurs in the implementation of ``VenariAI`` or in the underlying system frameworks. Where this occurs, ``VenariAIError/internalError(error:)`` provides this information, with additional context if it is available.
///
/// ### Getting an error description
///
/// ``VenariAIError`` conforms to the [`LocalizedError`](https://developer.apple.com/documentation/foundation/localizederror) protocol. As such a readable description of the error is provided through the [`errorDescription`](https://developer.apple.com/documentation/foundation/localizederror/2946895-errordescription) property.
///
/// ## Topics
///
/// ### Errors
...
/// - ``VenariAIError/failedToSerializeRequestParameters(_:)``
/// - ``VenariAIError/failedToConstructRequest(_:)``
/// - ``VenariAIError/failedToMakeNetworkRequest(error:)``
/// - ``VenariAIError/failedToHandleResponse(_:)``
/// - ``VenariAIError/internalError(error:)``
///
/// ### Error failure information
/// - ``VenariAIError/RequestURLConstructionFailureReason``
/// - ``VenariAIError/ParameterSerializationFailureReason``
/// - ``VenariAIError/RequestConstructionFailureReason``
/// - ``VenariAIError/ResponseHandlingFailureReason``
///
/// ### Convenience properties
/// - ``VenariAIError/underlyingError``
public enum VenariAIError: Swift.Error {
    /// Failure reasons for ``VenariAIError/failedToConstructRequestURL(_:)`` errors
    ...
    /// Failure reasons for ``VenariAIError/failedToSerializeRequestParameters(_:)`` errors
    ...
    /// Failure reasons for ``VenariAIError/failedToConstructRequest(_:)`` errors
    ...
    /// Failure reasons for ``VenariAIError/failedToHandleResponse(_:)`` errors
...
extension VenariAIError: LocalizedError {
...
extension VenariAIError.RequestURLConstructionFailureReason {
...
extension VenariAIError.ParameterSerializationFailureReason {
    public var localizedDescription: String {
        switch self {
...
extension VenariAIError.RequestConstructionFailureReason {
    public var localizedDescription: String {
        switch self {
        case .missingRequiredRequestBody:
...
extension VenariAIError.ResponseHandlingFailureReason {
    public var localizedDescription: String {
        switch self {
        case .failedToDecodeResponse:
